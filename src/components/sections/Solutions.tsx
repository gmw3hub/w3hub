...
const SOLUTIONS: Solution[] = [
  {
    ...
    body: "Become part of Berlin's most active builder community. Choose from flexible desks to dedicated workspaces that fit your style, with well-equipped facilities and community events where builders, startups and creatives meet.",
    href: "/co-working",
    images: [
